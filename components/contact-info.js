        ...
        <div className="px-4 py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-white rounded-lg shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Contact information */}
              <div className="relative px-6 py-10 overflow-hidden bg-cyan-600 sm:px-10 xl:p-12">
                <div
                ...
                {/* <p className="max-w-3xl mt-6 text-base text-cyan-50">
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-cyan-50">
                    <PhoneIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="ml-3">+61 (047) 206-550</span>
                  </dd>
                  <dd className="flex text-base text-cyan-50">
                    <LocationMarkerIcon
                      className="flex-shrink-0 w-6 h-6 text-cyan-200"
                    ...
                    />
                    <span className="ml-3">
                      133 Timberlea Dr, Bentley Park QLD 4869
                    </span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-cyan-50">
                    <MailIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="ml-3">info@coldxposure.com</span>
                  </dd>
                </dl>
              ...
              {/* Google Map */}
              <div className="relative h-0 overflow-hidden pb-[85%]">
                <MapBox />
              </div>
            </div>
          </div>
