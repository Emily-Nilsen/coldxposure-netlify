    ...
    <div className="relative py-16 overflow-hidden bg-white">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-lg max-w-prose">
          <h1>
            <span className="block text-base font-semibold tracking-wide text-center uppercase text-cyan-500">
              latest
            </span>
            <span className="block mt-2 text-3xl font-extrabold leading-8 tracking-tight text-center text-zinc-700 sm:text-4xl">
              Blog title
            </span>
          </h1>
        ...
        <div className="mx-auto mt-6 prose prose-lg prose-cyan text-zinc-500">
          <p>
          ...
          <figure>
            <Image
              ...
              src="/static/benefits_09.jpg"
              alt="Happy man standing in the street"
              width={1920}
              height={1280}
              layout="responsive"
              objectFit="cover"
